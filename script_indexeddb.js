...
function displayItems(category) {
    ...
    filteredItems.forEach(item => {
        ...
        itemDiv.innerHTML = `
            <img src="${item.pic}" style="height: 50%; margin: 20px; text-align: center;"/>
            <p>${item.name}</p>
...
async function populateDefaultData() {
  ...
  if (existingItems.length === 0) {
    await db.items.bulkAdd([
      ...
      {name:"גוורצטרמינר ריזלינג- בלו נאן", category:"Whites", price:51.9, pic:"imgs/whites/blue_nan1.png", origin:"גרמניה"},
      {name:"גוורצטרמינר ספיישל רזרב", category:"Whites", price:70, pic:"imgs/whites/g_s_r1.png", origin:"גליל עליון והרי ירושלים"},
      {name:"יין לבן חצי יבש של סגל", category:"Whites", price:21.9, pic:"imgs/whites/h_dry_sgv1.png", origin:"שפלת יהודה, ישראל"},
      {name:"עברי שרדונה", category:"Whites", price:55, pic:"imgs/whites/hebrew_s1.png", origin:"ישראל"},
      {name:"מאד האוס סוביניון בלאן", category:"Whites", price:74.9, pic:"imgs/whites/mh_sb1.png", origin:"ניו זילנד"},
      {name:"יין לבן הר חרמון", category:"Whites", price:37.9, pic:"imgs/whites/mnt_her1.png", origin:"רמת גולן, ישראל"},
      {name:"יין לבן שרדונה קלאסיק", category:"Whites", price:35.9, pic:"imgs/whites/srdn_brkn1.png", origin:"גליל עליון והרי ירושלים"},
      {name:"טורס דה אספניה בלאנקו", category:"Whites", price: 44.9, pic:"imgs/whites/tte_b1.png", origin:"ספרד"},
